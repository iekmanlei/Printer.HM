...
- Contains the codes for the heating operation and the printing operation. 
  - Printing operation
    - Python templates
      - ['test_coordinates.py'](./Codes/Printing operation/Python templates/test_coordinates.py): Python template for printing operations that use coordinates as the geometry input. 
